...
public class ProdutoResourceTeste {
	...
	public void deve_trazer_um_produto_pelo_id() throws Exception {
		...
		when().
			get("http://localhost:8080/testesdesoftware/rest/produtos/17");
	}
	...
	public void deve_retornar_todos_os_produtos() throws Exception {
		Response json = given().
				accept(MediaType.APPLICATION_JSON).
			when().
				get("http://localhost:8080/testesdesoftware/rest/produtos/8");
	...
	public void deve_excluir_um_produto() throws Exception {
		given().
	       	delete("http://localhost:8080/testesdesoftware/rest/produtos/2").
	    then()
	    	.statusCode(200);
	}
	...
	public void deve_trazer_um_produto_pelo_id_json_path() throws Exception {
		Response json = given().
			accept(MediaType.APPLICATION_JSON).
		when().
			get("http://localhost:8080/testesdesoftware/rest/produtos/18");
